				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<input name="contact" id="" cols="30" rows="2" class="form-control" required="" type="tel"maxlength="10" placeholder="enter 10 digitphone number"></input>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="number" step="any" class="form-control" name="latitude" required="true "placeholder="latitude">
							</div>
							<div class="form-group">
								<label for="" class="control-label">longitude</label>
								<input type="number"step="any" class="form-control" name="longitude" required="true "placeholder="longitude">
							</div>
