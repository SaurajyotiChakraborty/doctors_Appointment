...
<div class="container-fluid myModal">
	<div class="col-lg-12">
		<div id="msg"></div>
		<form action="" id="manage-appointment">
			...
			<div class="col-md-12 text-center">
				...
				<button class="btn btn-secondary btn-sm col-md-4  " type="button" onClick( window.close) data-dismiss="modal" id="close-btn">Close</button>
			</div>
		</form>
	</div>
</div>
